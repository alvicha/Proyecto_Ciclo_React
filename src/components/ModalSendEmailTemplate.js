        ...
        <div className="card flex justify-content-center">
            ...
            >
                <div className="mt-3">
                    ...
                    <InputText type="email" className="mb-2 w-50" placeholder="Introduce correo de destinatario" value={nameAddressee} onChange={(e) => setNameAddressee(e.target.value)} aria-labelledby="name" />
                </div>
            </Dialog>
