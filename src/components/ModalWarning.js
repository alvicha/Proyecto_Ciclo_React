const ModalWarning = ({ setVisibleModalWarning, onConfirmChange, onCancelChange, warningMessage }) => {
    return (
        <>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="close" onClick={onCancelChange} aria-label="Close">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" onClick={onCancelChange}>Cancelar</button>
