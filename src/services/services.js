...
export const getPlaceholdersContexts = async (searchPlaceholder, setAlert, setVisibleAlert) => {
  try {
    let response = "";
...
export const getTemplatesContexts = async (context, setAlert, setVisibleAlert) => {
  try {
    let response = "";
